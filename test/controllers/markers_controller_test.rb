...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { name: @marker.name, subcategory_id: @marker.subcategory_id, url: @marker.url } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { name: @marker.name, subcategory_id: @marker.subcategory_id, url: @marker.url } }
